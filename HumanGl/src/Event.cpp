...
/*   Updated: 2021/10/06 14:53:52 by ydemange         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Event::_keychange(SDL_Keycode kc, unsigned key_state)
{
	switch (kc)
	{
		...
		case (SDLK_LEFT) : if (key_state) this->key.left = !this->key.left; break;
		// case (SDLK_UP) : if (key_state) this->key.up = !this->key.up; break;
